...
const Contacts = () => {
  ...
  useEffect(() => {
    ...
    const handleCalculatorData = (event) => {
      console.log(
        "📨 Получены данные от калькулятора через event:",
        event.detail,
      );
      if (event.detail) {
  ...
  useEffect(() => {
    if (window.location.hash === "#contact") {
      console.log(
        "📍 Страница загружена сразу на контактах, загружаем данные...",
      );
      setTimeout(() => {
        loadCalculatorDataFromStorage();
      }, 500);
  ...
  const submitToGoogleForms = async () => {
    ...
    const fields = {
      ...
      "entry.1639246950": calculatorData
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validateForm()) {
      alert(
        "Пожалуйста, исправьте ошибки в форме и дайте все необходимые согласия",
      );
      return;
    }
  ...
  const isFormValid = () => {
    const allFieldsFilled =
      formData.name && formData.phone && formData.contactMethod;
    const allConsentsGiven =
      consents.privacyPolicyRead && consents.dataProcessing;
    const noErrors =
      !errors.name &&
      !errors.phone &&
          ...
          <div className="contacts-grid">
            ...
            <div className="contacts-info">
              ...
              <div className="contacts-item">
                ...
                >
                  <span className="contacts-item-span">
            ...
            <div className="contacts-form-block">
              ...
              {calculatorData && (
                ...
                >
                  ...
                  <p style={{ margin: "5px 0" }}>
                    <strong>
                      {calculatorData.service === "Мойка окон"
                        ? "Количество окон"
                        : "Площадь"}
                      :
                    </strong>{" "}
                    {calculatorData.meters}{" "}
                    {calculatorData.service === "Мойка окон" ? "окон" : "м²"}
                  </p>
                  <p style={{ margin: "5px 0" }}>
              ...
              >
                ...
                <div className="form-row">
                  <div
                    className="form-group privacy-consents-group"
                    style={{
                      padding: "0px",
                      borderRadius: "8px",
                    }}
                  >
                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          (ФИО, телефон, параметры объекта) в целях обработки
                          заявки, заключения и исполнения договора на оказание
                          клининговых услуг. Срок действия согласия: до
