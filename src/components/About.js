        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <div className="about-description">
              <p>
                До создания {company.brandName}  я пять лет работала в  логистической компании, где прошла путь от выполнения линейных задач до оптимизации сложных операционных цепочек. Задача была — превратить хаотичные процессы в отлаженные конвейеры, где человеческий фактор сводится к минимуму, а результат предсказуем.
              </p>
              <p>
              ...
              <p>
                Я создала {company.brandName} как компанию, где качество — не случайность, а следствие продуманных до мелочей стандартов и процессов.
              </p>
            </div>
